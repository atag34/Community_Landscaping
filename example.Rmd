...
```
I will manually run through some names that seem like they should be excluded. My reasoning being that they are either obviously of national interest or may be a news source rather than the topic. I tried to leave anything ambigious in.
```{r, echo=T}
...
get_terms(lda,5)
```
We also want to significantly reduce the number of dimensions in order to better explain the data.
